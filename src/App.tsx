...
const AutoAnnoLetters = React.lazy(() =>
  import('./components/auto_anno/AutoAnnoLetters').catch((_err) => {
...
const IndexLetters = React.lazy(() =>
  import('./components/pages/editor/IndexLetters').catch((_err) => {
    window.location.reload(); // oder Redirect zur Startseite
    return new Promise(() => {});
  }),
);
const ShowEditor = React.lazy(() =>
  import('./components/pages/editor/ShowEditor').catch((_err) => {
    window.location.reload(); // oder Redirect zur Startseite
    return new Promise(() => {});
  }),
);
