...
const DialogContentComponents: Record<string, (props: DefaultDialogProps & any) => React.ReactNode> = {
	...
	[EditorConstants.dialogTypes.DATE_WHEN_CUSTOM_ADD]: (props) => (<DateAddDialog {...props} dateType={EditorConstants.dateDialog.dateTypes.WHEN_CUSTOM}/>),
	[EditorConstants.dialogTypes.DATE_NOT_AFTER_ADD]: (props) => (<DateAddDialog {...props} dateType={EditorConstants.dateDialog.dateTypes.NOT_AFTER}/>),
	[EditorConstants.dialogTypes.DATE_NOT_BEFORE_ADD]: (props) => (<DateAddDialog {...props} dateType={EditorConstants.dateDialog.dateTypes.NOT_BEFORE}/>),
	[EditorConstants.dialogTypes.DATE_FROM_TO_ADD]: (props) => (<DateAddDialog {...props} dateType={EditorConstants.dateDialog.dateTypes.FROM_TO}/>),
	[EditorConstants.dialogTypes.DATE_NOT_BEFORE_AFTER_ADD]: (props) => (<DateAddDialog {...props} dateType={EditorConstants.dateDialog.dateTypes.NOT_BEFORE_NOT_AFTER}/>),
	...
	[EditorConstants.dialogTypes.MANAGE_GREETINGS_FORMULA]: (props) => (<GreetingsFormulaDialog {...props} formulaType={EditorConstants.dialogTypes.MANAGE_GREETINGS_FORMULA}/> ),
...
const EditorFormDialog = (props: EditorFormDialogProps) => {
 const dispatch = useAppDispatch()
  ...
  useEffect(() => {
	...
	const onSaveDialogHandler = async (updatedXmlDoc: Document, changeType: string, successMessage: string, _xmlId: string, extraFn?:(doc: Document) => void) => {
		try {
    ...
    <React.Fragment>
      ...
      >
        ...
        <DialogContent sx={{ p: 2, width: dialogWidth }}>
					{ dialogType && DialogContentComponents[dialogType] ({
						xmlDoc,
						xmlRef,
