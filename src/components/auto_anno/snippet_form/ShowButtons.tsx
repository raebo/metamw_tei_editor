      ...
      <div className="autoSnippetFormRow">
        ...
        <div className="form-item form-item--buttons">
          <ButtonGroup size="small" variant="contained" aria-label="Basic button group">
            <Button color="info" onClick={() => activateEditMode()}>
              Anpassen
            </Button>
            <Button color="info" onClick={() => handleRejectSnippet()}>
              Verwerfen
            </Button>
            <Button
              color="primary"
              disabled={sharedSnippet?.referenceKeyChanged ? false : true}
              onClick={() => handleAcceptSnippet()}
            >
              Übernehmen
            </Button>
          </ButtonGroup>
