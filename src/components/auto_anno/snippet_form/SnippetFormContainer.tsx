...
const SnippetFormContainer = (props: SnippetFormContainerProps) => {
  ...
  const [selectedComponentForm, setSelectedComponentForm] =
    useState<SnippetComponentMappingItem | null>(null);
  const [selectedComponentButtons, setSelectedComponentButtons] =
    useState<SnippetComponentMappingItem | null>(null);
      ...
      component: (
        <EditButtons
          ...
          cancelClickedCallback={() => {
            dispatch(
              setAutoSnippetFormContainer({
                snippetFormContainer: { form: 'BLANK_FORM', buttons: 'BLANK_BUTTONS' },
              }),
            );
